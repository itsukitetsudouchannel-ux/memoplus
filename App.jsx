...
const BUILTIN_DECKS = [
  { id:"b1", name:"中学英単語 基礎", emoji:"🌱", source:"builtin", cards:[
    ...
    { front:"book",        back:"本",         hint:"名詞" },
    { front:"cat",         back:"猫",         hint:"名詞" },
    { front:"dog",         back:"犬",         hint:"名詞" },
    { front:"eat",         back:"食べる",     hint:"動詞" },
    { front:"family",      back:"家族",       hint:"名詞" },
    { front:"go",          back:"行く",       hint:"動詞" },
    { front:"happy",       back:"幸せな",     hint:"形容詞" },
    { front:"idea",        back:"考え・アイデア", hint:"名詞" },
    { front:"jump",        back:"跳ぶ",       hint:"動詞" },
    { front:"kind",        back:"親切な",     hint:"形容詞" },
    { front:"like",        back:"好む・好き",  hint:"動詞" },
    { front:"make",        back:"作る",       hint:"動詞" },
    { front:"name",        back:"名前",       hint:"名詞" },
    { front:"open",        back:"開ける・開いた", hint:"動詞/形容詞" },
    { front:"play",        back:"遊ぶ・演奏する", hint:"動詞" },
    { front:"question",    back:"質問",       hint:"名詞" },
    { front:"run",         back:"走る",       hint:"動詞" },
    { front:"school",      back:"学校",       hint:"名詞" },
    { front:"talk",        back:"話す",       hint:"動詞" },
    { front:"under",       back:"〜の下に",   hint:"前置詞" },
    { front:"very",        back:"とても",     hint:"副詞" },
    { front:"walk",        back:"歩く",       hint:"動詞" },
    { front:"year",        back:"年",         hint:"名詞" },
    { front:"zoo",         back:"動物園",     hint:"名詞" },
    { front:"also",        back:"〜も・また",  hint:"副詞" },
    { front:"bring",       back:"持ってくる", hint:"動詞" },
    { front:"city",        back:"都市・市",   hint:"名詞" },
    { front:"dream",       back:"夢",         hint:"名詞" },
    { front:"early",       back:"早い・早く",  hint:"形容詞/副詞" },
    { front:"flower",      back:"花",         hint:"名詞" },
    { front:"give",        back:"与える",     hint:"動詞" },
    { front:"help",        back:"助ける・助け", hint:"動詞/名詞" },
    { front:"important",   back:"大切な・重要な", hint:"形容詞" },
    { front:"just",        back:"ちょうど・ただ〜だけ", hint:"副詞" },
    { front:"keep",        back:"保つ・続ける", hint:"動詞" },
    { front:"learn",       back:"学ぶ・習う",  hint:"動詞" },
    { front:"move",        back:"動く・引っ越す", hint:"動詞" },
    { front:"need",        back:"必要とする",  hint:"動詞" },
    { front:"often",       back:"しばしば・よく", hint:"副詞" },
    { front:"place",       back:"場所",       hint:"名詞" },
    { front:"ready",       back:"準備ができた", hint:"形容詞" },
    { front:"show",        back:"見せる・番組", hint:"動詞/名詞" },
    { front:"think",       back:"考える・思う", hint:"動詞" },
    { front:"use",         back:"使う・使用",  hint:"動詞/名詞" },
    { front:"visit",       back:"訪問する",   hint:"動詞" },
    { front:"want",        back:"欲しい・〜したい", hint:"動詞" },
    { front:"write",       back:"書く",       hint:"動詞" },
    { front:"young",       back:"若い",       hint:"形容詞" },
    { front:"small",       back:"小さい",     hint:"形容詞" },
    { front:"large",       back:"大きい・広い", hint:"形容詞" },
  ]},
  { id:"b2", name:"中学英単語 発展", emoji:"📗", source:"builtin", cards:[
    { front:"abroad",      back:"海外に・外国に", hint:"副詞" },
    { front:"achieve",     back:"達成する",   hint:"動詞" },
    { front:"believe",     back:"信じる",     hint:"動詞" },
    { front:"careful",     back:"注意深い",   hint:"形容詞" },
    { front:"change",      back:"変える・変化", hint:"動詞/名詞" },
    { front:"decide",      back:"決める",     hint:"動詞" },
    { front:"enjoy",       back:"楽しむ",     hint:"動詞" },
    { front:"explain",     back:"説明する",   hint:"動詞" },
    { front:"feel",        back:"感じる",     hint:"動詞" },
    { front:"forget",      back:"忘れる",     hint:"動詞" },
    { front:"grow",        back:"成長する・育てる", hint:"動詞" },
    { front:"happen",      back:"起こる",     hint:"動詞" },
    { front:"interest",    back:"興味・関心",  hint:"名詞" },
    { front:"invite",      back:"招待する",   hint:"動詞" },
    { front:"join",        back:"参加する",   hint:"動詞" },
    { front:"knowledge",   back:"知識",       hint:"名詞" },
    { front:"leave",       back:"去る・出発する", hint:"動詞" },
    { front:"message",     back:"メッセージ・伝言", hint:"名詞" },
    { front:"nature",      back:"自然",       hint:"名詞" },
    { front:"opinion",     back:"意見",       hint:"名詞" },
    { front:"popular",     back:"人気のある",  hint:"形容詞" },
    { front:"practice",    back:"練習する・練習", hint:"動詞/名詞" },
    { front:"promise",     back:"約束する・約束", hint:"動詞/名詞" },
    { front:"protect",     back:"守る・保護する", hint:"動詞" },
    { front:"receive",     back:"受け取る",   hint:"動詞" },
    { front:"remember",    back:"覚えている・思い出す", hint:"動詞" },
    { front:"respect",     back:"尊敬する・尊重", hint:"動詞/名詞" },
    { front:"same",        back:"同じ",       hint:"形容詞" },
    { front:"send",        back:"送る",       hint:"動詞" },
    { front:"share",       back:"共有する・分かち合う", hint:"動詞" },
    { front:"smile",       back:"微笑む・笑顔", hint:"動詞/名詞" },
    { front:"solve",       back:"解く・解決する", hint:"動詞" },
    { front:"spend",       back:"過ごす・使う", hint:"動詞" },
    { front:"step",        back:"歩み・段階",  hint:"名詞" },
    { front:"strange",     back:"奇妙な・見知らぬ", hint:"形容詞" },
    { front:"succeed",     back:"成功する",   hint:"動詞" },
    { front:"support",     back:"支援する・支持", hint:"動詞/名詞" },
    { front:"surprise",    back:"驚かせる・驚き", hint:"動詞/名詞" },
    { front:"teach",       back:"教える",     hint:"動詞" },
    { front:"terrible",    back:"ひどい・恐ろしい", hint:"形容詞" },
    { front:"tradition",   back:"伝統",       hint:"名詞" },
    { front:"trouble",     back:"問題・困難",  hint:"名詞" },
    { front:"try",         back:"試みる・やってみる", hint:"動詞" },
    { front:"turn",        back:"曲がる・回る・番", hint:"動詞/名詞" },
    { front:"understand",  back:"理解する",   hint:"動詞" },
    { front:"wait",        back:"待つ",       hint:"動詞" },
    { front:"wonder",      back:"〜かと思う・不思議に思う", hint:"動詞" },
    { front:"word",        back:"言葉・単語",  hint:"名詞" },
    { front:"work",        back:"働く・機能する・仕事", hint:"動詞/名詞" },
    { front:"world",       back:"世界",       hint:"名詞" },
    { front:"worry",       back:"心配する",   hint:"動詞" },
  ]},
  { id:"b3", name:"高校英単語 標準", emoji:"📘", source:"builtin", cards:[
    { front:"abandon",     back:"捨てる・諦める", hint:"動詞" },
    { front:"abstract",    back:"抽象的な",   hint:"形容詞" },
    { front:"accurate",    back:"正確な",     hint:"形容詞" },
    { front:"adapt",       back:"適応する・改作する", hint:"動詞" },
    { front:"adequate",    back:"十分な・適切な", hint:"形容詞" },
    { front:"admire",      back:"称賛する",   hint:"動詞" },
    { front:"affect",      back:"影響を与える", hint:"動詞" },
    { front:"aggressive",  back:"攻撃的な・積極的な", hint:"形容詞" },
    { front:"ancient",     back:"古代の",     hint:"形容詞" },
    { front:"anxiety",     back:"不安・心配",  hint:"名詞" },
    { front:"apparent",    back:"明らかな・外見上の", hint:"形容詞" },
    { front:"appreciate",  back:"感謝する・評価する", hint:"動詞" },
    { front:"appropriate", back:"適切な",     hint:"形容詞" },
    { front:"approve",     back:"承認する・賛成する", hint:"動詞" },
    { front:"argue",       back:"議論する・主張する", hint:"動詞" },
    { front:"assume",      back:"想定する・〜と思う", hint:"動詞" },
    { front:"attach",      back:"付ける・添付する", hint:"動詞" },
    { front:"attempt",     back:"試みる・試み", hint:"動詞/名詞" },
    { front:"attitude",    back:"態度・姿勢",  hint:"名詞" },
    { front:"avoid",       back:"避ける",     hint:"動詞" },
    { front:"aware",       back:"気づいている・意識している", hint:"形容詞" },
    { front:"benefit",     back:"利益・恩恵",  hint:"名詞" },
    { front:"capable",     back:"〜できる・有能な", hint:"形容詞" },
    { front:"cause",       back:"原因・引き起こす", hint:"名詞/動詞" },
    { front:"challenging", back:"困難な・やりがいのある", hint:"形容詞" },
    { front:"compare",     back:"比較する",   hint:"動詞" },
    { front:"complex",     back:"複雑な",     hint:"形容詞" },
    { front:"concern",     back:"心配・関心・関係する", hint:"名詞/動詞" },
    { front:"confident",   back:"自信のある",  hint:"形容詞" },
    { front:"conflict",    back:"対立・衝突",  hint:"名詞" },
    { front:"consequence", back:"結果・影響",  hint:"名詞" },
    { front:"consider",    back:"考慮する・〜だと考える", hint:"動詞" },
    { front:"contribute",  back:"貢献する",   hint:"動詞" },
    { front:"convince",    back:"説得する・確信させる", hint:"動詞" },
    { front:"critical",    back:"重要な・批判的な", hint:"形容詞" },
    { front:"culture",     back:"文化",       hint:"名詞" },
    { front:"debate",      back:"議論・討論する", hint:"名詞/動詞" },
    { front:"define",      back:"定義する",   hint:"動詞" },
    { front:"demand",      back:"要求する・需要", hint:"動詞/名詞" },
    { front:"demonstrate", back:"示す・証明する", hint:"動詞" },
    { front:"depend",      back:"頼る・〜次第である", hint:"動詞" },
    { front:"describe",    back:"描写する・説明する", hint:"動詞" },
    { front:"despite",     back:"〜にもかかわらず", hint:"前置詞" },
    { front:"develop",     back:"発展する・開発する", hint:"動詞" },
    { front:"discipline",  back:"規律・訓練",  hint:"名詞" },
    { front:"diverse",     back:"多様な",     hint:"形容詞" },
    { front:"encourage",   back:"励ます・促進する", hint:"動詞" },
    { front:"enhance",     back:"高める・向上させる", hint:"動詞" },
    { front:"environment", back:"環境",       hint:"名詞" },
    { front:"establish",   back:"設立する・確立する", hint:"動詞" },
  ]},
  { id:"b4", name:"高校英単語 上級", emoji:"📙", source:"builtin", cards:[
    { front:"elaborate",   back:"詳細な・精巧な", hint:"形容詞" },
    { front:"eliminate",   back:"排除する・取り除く", hint:"動詞" },
    { front:"emerge",      back:"現れる・台頭する", hint:"動詞" },
    { front:"emphasize",   back:"強調する",   hint:"動詞" },
    { front:"evaluate",    back:"評価する",   hint:"動詞" },
    { front:"evidence",    back:"証拠",       hint:"名詞" },
    { front:"evolve",      back:"進化する",   hint:"動詞" },
    { front:"exaggerate",  back:"誇張する",   hint:"動詞" },
    { front:"explore",     back:"探求する・探検する", hint:"動詞" },
    { front:"extent",      back:"程度・範囲",  hint:"名詞" },
    { front:"factor",      back:"要因・要素",  hint:"名詞" },
    { front:"failure",     back:"失敗・故障",  hint:"名詞" },
    { front:"flexible",    back:"柔軟な",     hint:"形容詞" },
    { front:"focus",       back:"焦点・集中する", hint:"名詞/動詞" },
    { front:"fundamental", back:"基本的な・根本的な", hint:"形容詞" },
    { front:"generate",    back:"生み出す・発生させる", hint:"動詞" },
    { front:"global",      back:"世界的な・地球規模の", hint:"形容詞" },
    { front:"gradually",   back:"徐々に",     hint:"副詞" },
    { front:"guarantee",   back:"保証する・保証", hint:"動詞/名詞" },
    { front:"hypothesis",  back:"仮説",       hint:"名詞" },
    { front:"ignore",      back:"無視する",   hint:"動詞" },
    { front:"illustrate",  back:"説明する・例示する", hint:"動詞" },
    { front:"immediate",   back:"即座の・直接の", hint:"形容詞" },
    { front:"impact",      back:"影響・衝撃",  hint:"名詞" },
    { front:"imply",       back:"暗示する・意味する", hint:"動詞" },
    { front:"inevitable",  back:"避けられない・必然的な", hint:"形容詞" },
    { front:"influence",   back:"影響・影響を与える", hint:"名詞/動詞" },
    { front:"inspire",     back:"鼓舞する・刺激する", hint:"動詞" },
    { front:"interpret",   back:"解釈する・通訳する", hint:"動詞" },
    { front:"investigate", back:"調査する",   hint:"動詞" },
    { front:"involve",     back:"含む・〜に関わる", hint:"動詞" },
    { front:"maintain",    back:"維持する・主張する", hint:"動詞" },
    { front:"majority",    back:"大多数・過半数", hint:"名詞" },
    { front:"moral",       back:"道徳的な・道徳", hint:"形容詞/名詞" },
    { front:"motivate",    back:"動機づける",  hint:"動詞" },
    { front:"navigate",    back:"航行する・うまく対処する", hint:"動詞" },
    { front:"numerous",    back:"多数の",     hint:"形容詞" },
    { front:"objective",   back:"客観的な・目標", hint:"形容詞/名詞" },
    { front:"obtain",      back:"得る・獲得する", hint:"動詞" },
    { front:"overcome",    back:"克服する",   hint:"動詞" },
    { front:"phenomenon",  back:"現象",       hint:"名詞" },
    { front:"potential",   back:"可能性・潜在的な", hint:"名詞/形容詞" },
    { front:"precisely",   back:"正確に・まさに", hint:"副詞" },
    { front:"preserve",    back:"保存する・守る", hint:"動詞" },
    { front:"primary",     back:"主な・最初の", hint:"形容詞" },
    { front:"principle",   back:"原則・原理",  hint:"名詞" },
    { front:"prospect",    back:"見通し・見込み", hint:"名詞" },
    { front:"relevant",    back:"関連した・適切な", hint:"形容詞" },
    { front:"significant", back:"重要な・著しい", hint:"形容詞" },
    { front:"strategy",    back:"戦略",       hint:"名詞" },
    { front:"sufficient",  back:"十分な",     hint:"形容詞" },
  ]},
];
